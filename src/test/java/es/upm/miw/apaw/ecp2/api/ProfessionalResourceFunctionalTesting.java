...
public class ProfessionalResourceFunctionalTesting {
    ...
    public void testSeeProfessional() {
		this.createProfessional();
        HttpRequest request = new HttpRequestBuilder().method(HttpMethod.GET).path(ProfessionalResource.PROFESSIONALS).path(ProfessionalResource.PHONES).expandPath("1").build();
    ...
    public void testSeeLevelProfessional() {
		...
		HttpRequest request = new HttpRequestBuilder().method(HttpMethod.GET).path(ProfessionalResource.PROFESSIONALS).path(ProfessionalResource.PHONES).path(ProfessionalResource.LEVEL).body("1:55555555:NORMAL").build();
